...
declare type RuleLevel = Severity | 'off' | 'warn' | 'error';
declare type RuleLevelAndOptions<Options extends any[] = any[]> = Prepend<Partial<Options>, RuleLevel>;
declare type TemplateLintRuleDefinition = RuleLevel | RuleLevelAndOptions;
declare type TemplateLintPending = string | TemplateLintPendingWithExclusions;
declare type TemplateLintPlugin = string | TemplateLintPluginObject;
